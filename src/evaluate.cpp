...
namespace {
  ...
  Score MobilityBonus[][32] = {
    { S(-75,-77), S(-56,-55), S( -9,-29), S( -3,-9), S(  6,  4), S( 14, 12), // Knights
      S( 22, 26), S( 29, 29), S( 35, 29) },
    { S(-48,-58), S(-19,-23), S( 15, -2), S( 25, 13), S( 38, 24), S( 50, 43), // Bishops
      S( 54, 55), S( 64, 55), S( 64, 65), S( 71, 74), S( 80, 79), S( 82, 86),
      S( 91, 88), S( 99, 96) },
    { S(-57,-76), S(-27,-18), S(-15, 28), S(-9, 57), S( -4, 70), S( -2, 82), // Rooks
      S( 10,113), S( 16,116), S( 29,129), S( 29,144), S( 32,155), S( 40,166),
      S( 45,169), S( 48,169), S( 56,170) },
    { S(-39,-34), S(-21,-15), S(  3,  7), S(  3, 17), S( 13, 34), S( 22, 53), // Queens
      S( 28, 60), S( 40, 72), S( 45, 81), S( 47, 92), S( 57, 95), S( 62,103),
      S( 59,114), S( 66,121), S( 65,121), S( 69,123), S( 73,133), S( 71,136),
      S( 80,143), S( 85,144), S( 87,150), S( 93,169), S(101,170), S(100,172),
      S(105,188), S(108,191), S(111,212), S(117,209) }
  };

TUNE(SetRange(-200, 400), MobilityBonus);
